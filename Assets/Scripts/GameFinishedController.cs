...
public class GameFinishedController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //reset level to 1
        databaseController.setLevel(1, name);
        //get their score
        totalScore = Convert.ToInt32(databaseController.getTotalScore(name));
        //display their name, a congrats and their train and animals
        congrats.text = "Congratulations " + name + " you finished the game!";
        this.checkPoints();
